      ...
      child: GestureDetectorTr(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Text(is_english_txt_enable?"Debit/Credit Card":"Tarjeta Crédito/Débito",
              style: TextStyle(
                fontFamily: 'Roboto',
                color: Color(0xffffffff),
                fontSize: 20,
...
String getBtnNameFromRechargeEnum (RechargeType rechargeOpts) {
  switch (rechargeOpts){
    ...
    case RechargeType.VISA: return is_english_txt_enable?"Debit/Credit Card":"Tarjeta Crédito/Débito";
