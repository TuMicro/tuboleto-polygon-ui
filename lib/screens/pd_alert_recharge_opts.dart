  ...
  Widget build(BuildContext context) {
      ...
      child: GestureDetectorTr(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Text(english_txt_enable?"Debit/Credit Card":"Tarjeta Crédito/Débito",
              style: TextStyle(
                fontFamily: 'Roboto',
                color: Color(0xffffffff),
                fontSize: 20,
    ...
    final mainColumn = Column(
      ...
      children: <Widget>[
        ...
        verticalSpace(26),
        Text(english_txt_enable?"How would you like to\ntop up your balance?\n":"Con qué medio de pago te\ngustaría recargar saldo?\n",
          style: TextStyle(
            fontFamily: 'Roboto',
        ...
        verticalSpace(12),
        is_production?Container():btnOptNear,
        is_production?Container():verticalSpace(16),
        is_production?Container():btnOpt0,
        is_production?Container():verticalSpace(16),
        btnOpt1,
        is_production?verticalSpace(16):Container(),
        is_production?btnOpt2:Container(),
        verticalSpace(30),
      ],
    );
...
String getBtnNameFromRechargeEnum (RechargeType rechargeOpts) {
  switch (rechargeOpts){
    ...
    case RechargeType.VISA: return english_txt_enable?"Debit/Credit Card":"Tarjeta Crédito/Débito";
